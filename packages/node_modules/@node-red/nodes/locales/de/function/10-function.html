...
<script type="text/x-red" data-help-name="function">
  ...
  <p> Die Nachrichten werden als JavaScript-Objekt mit dem Namen  <code>msg</code> übergeben - im folegenden "Nachrichtenobjekt" genannt. </p>
  <p> Er erwartet eine Eigenschaft <code> msg.payload </code>, die den Hauptteil der Nachricht enthält (die Nutzdaten). </p>
  <p> Die Funktion soll ein Nachrichtenobjekt (oder mehrere Nachrichtenobjekte) zurückgegeben, kann aber
  ...
  <p> Die Funktion kann die Nachrichtenobjekte zurückgeben (als Rückgabewert), die sie an den nächsten Node im Flow weitergeben möchte
    oder kann  <code>node.send (msg)</code> aufrufen. </p>
  <p> Es kann Folgendes zurückgeben/senden: </p>
  <ul>
    <li> Ein einzelnes Nachrichtenobjekt - übergeben an den Node, der mit der ersten Ausgabe verbunden ist </li>
    <li> ein Array von Nachrichtenobjekten, die an Nodes übergeben werden, die mit den entsprechenden Ausgaben verbunden sind </li>
  </ul>
  <p> Wenn ein Element des Arrays selbst ein Array von Nachrichtenobjekten ist, werden mehrere Nachrichten an die entsprechende Ausgabe gesendet. </p>
