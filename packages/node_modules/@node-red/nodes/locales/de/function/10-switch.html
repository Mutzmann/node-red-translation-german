...
<script type="text/x-red" data-help-name="switch">
    <p>Weiterleitung von Nachrichten basierend auf den Werten ihrer Eigenschaften oder der Position in einer Nachrichtenfolge (Sequenz).</p>
    <h3>Details</h3>
    <p>Wenn eine Nachricht ankommt, wertet der Node jede der definierten Regeln aus
        und leitet die Nachricht an die Ausgänge der übereinstimmenden Regeln weiter.</p>
    <p>Optional kann der Node so eingestellt werden, dass er die weitere Auswertung von Regeln einstellt,
        sobald er eine passende Regel gefunden hat.</p>
    <p>Die Regeln können anhand einer einzelnen Nachrichteneigenschaft, 
        einer Flow- oder globalen Kontext-Eigenschaft, einer Umgebungsvariable oder dem Ergebniss eines JSONata-Ausdrucks ausgewertet werden.</p>
    <h4>Regeln</h4>
    ...
    <ol>
        ...
        <li>Eine <b>Otherwise</b> Regel kann verwendet werden, um eine Übereinstimmung herzustellen, 
    ...
    <p>Die <code>is empty</code>Regel wird von nur Strings, Arrays und Buffern erfüllt, die eine Länge von 0 haben
         oder von Objekten, die keine Eigenschaften haben. Nicht aber für <code>null</code> oder <code>undefiniert</code>.</p>
