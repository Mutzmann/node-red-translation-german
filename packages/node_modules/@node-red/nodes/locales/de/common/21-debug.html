...
<script type="text/x-red" data-help-name="debug">
  <p> Zeigt die ausgewählten Nachrichteneigenschaften auf der Registerkarte "Debug" und 
    optional im Laufzeitprotokoll an. Standardmäßig wird <code>msg.payload</code> angezeigt. Es kann aber jede Nachrichteneigenschaft Feld, die gesamte Nachricht oder eine individuelle JSONata-Zeichenkette angezeigt werden. </p>
  <h3> Details </h3>
  <p> Die Registerkarte "Debug" bietet eine strukturierte Sicht der Nachrichten an 
    wodurch deren Struktur leichter zu verstehen ist. </p>
  <p> JavaScript-Objekte und -Arrays können nach Bedarf ausgeblendet und eingeblendet werden. 
    Pufferobjekte können, wenn möglich, als Rohdaten oder als Zeichenfolge angezeigt werden. </p>
  ...
  <p> Die Schaltfläche auf dem Node kann verwendet werden, um die Ausgabe zu aktivieren oder zu deaktivieren.
    Es wird empfohlen, alle Debug-Nodes, die nicht verwendet werden, zu deaktivieren oder zu entfernen. </p>
